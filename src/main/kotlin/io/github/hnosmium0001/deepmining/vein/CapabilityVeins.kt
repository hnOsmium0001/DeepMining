...
import io.github.hnosmium0001.deepmining.fromMod
...
val CAPABILITY_MINERAL_VEINS: Capability<MineralVeins>? = null
...
val CAPABILITY_FLUID_VEINS: Capability<FluidVeins>? = null
...
object CapabilityEventHandler {
    ...
    fun attachCaps(event: AttachCapabilitiesEvent<World>) {
        event.addCapability(fromMod("veins"), object : ICapabilityProvider {
